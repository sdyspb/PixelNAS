...
The Device Tree sources in this project are based on the `rk3568-roc-pc` project. This provides a solid foundation for enabling various hardware interfaces on the [AIO-3568J](https://en.t-firefly.com/product/industry/aio3568j) platform and custom module with 5x M.2 SATA or 4x M.2 SATA and integrated UPS.
